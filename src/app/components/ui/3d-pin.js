    ...
    (<Link
      ...
      <div
        ...
        <div
          ...
          className="absolute left-1/2 top-1/2 transition duration-700 overflow-hidden">
...
export const PinPerspective = ({
  ...
  return (
    (<motion.div
      className="pointer-events-none  w-80 h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <div
            className="relative flex space-x-2 items-center z-10 rounded-full bg-neutral-950 py-0.5 px-4 ring-1 ring-white/10 ">
            <span
              className="work-sans-font relative z-20 text-white text-sm inline-block py-1">
              {title}
            </span>
