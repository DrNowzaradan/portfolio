    ...
    (<div
      ...
      <AnimatePresence initial={false}>
        <motion.div
          ...
          {showHandlebar && (
            <div
              className="h-7 w-5 rounded-md top-1/2 -translate-y-1/2 bg-white z-30 -right-2.5 absolute flex items-center justify-center shadow-[0px_-1px_0px_0px_#FFFFFF40]">
              <ion-icon className="text-black" name="ellipsis-vertical"></ion-icon>
            </div>
          )}
        </motion.div>
      </AnimatePresence>
